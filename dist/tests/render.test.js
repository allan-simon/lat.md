...
import { renderMarkdown, escapeHtml, isSourceTarget, } from '../src/render/html.js';
...
describe('renderMarkdown', () => {
    ...
    it('passes raw HTML (widget iframes) through', async () => {
        const html = await renderMarkdown('<iframe src="_widgets/demo.html" height="200"></iframe>', resolve);
