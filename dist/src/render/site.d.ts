 ...
 */
export declare function buildResolver(allSections: Section[], sectionUrl: SectionUrl, sourceHref?: (target: string) => string | null): WikiLinkResolver;
...
export declare function buildSectionContent(found: SectionFound, resolver: WikiLinkResolver, sectionUrl: SectionUrl, codeRefHref?: (file: string, line: number) => string | null): Promise<string>;
/**
